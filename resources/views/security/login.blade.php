            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <p class="page-breadcrumb">
                        <a href="{{ route('client.home') }}">Вернуть назад</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="appointment-form-wrapper clearfix">
                        ...
                        <form class="appoinment-form" method="POST" action="{{ route('login.store') }}">
                            @csrf
                            <div class="form-group col-md-12">
                                <input id="your_name" class="form-control" name="iin" placeholder="ИИН"
                                    type="text">
                                <i class="fa fa-user-o"></i>
                            </div>
                            <div class="form-group col-md-12">
                                <input id="your_phone" class="form-control" name="password" placeholder="Пароль"
                                    type="password">
